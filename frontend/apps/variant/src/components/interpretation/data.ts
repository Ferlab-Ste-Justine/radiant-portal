  ...
  modal: {
    variant: {
      interpretation: {
        ...
        okText: "Save",
        lastUpdate:
          "Last update: <span style='font-weight:500;'>{name}</span> ({date, date, long}, {updatedAtTime})",
        header: {
          germline: "Germline",
          somatic: "Somatic",
        },
        ...
        somatic: {
          ...
          "clinicalUtility-options": {
            category_ia: "Category IA",
            category_ib: "Category IB",
            category_iic: "Category IIC",
            category_iid: "Category IID",
...
export const getClassificationCriteriaColor = (value: string) =>
  classificationCriterias.find((criteria) => criteria.value === value)?.color ||
  undefined;
...
export const getOncogenicityClassificationCriteriaColor = (value: string) =>
  oncogenicityClassificationCriterias.find(
...
export const getClinicalUtilitys = (): (MultiSelectorOption & {
  ...
  {
    label: getNestedValue(
      "modal.variant.interpretation.somatic.clinicalUtility-options.category_ia"
    ),
    value: "category_ia",
    title: "",
  },
  {
    label: getNestedValue(
      "modal.variant.interpretation.somatic.clinicalUtility-options.category_ib"
    ),
    value: "category_ib",
    title: "",
  },
  {
    label: getNestedValue(
      "modal.variant.interpretation.somatic.clinicalUtility-options.category_iic"
    ),
    value: "category_iic",
    title: "",
  },
  {
    label: getNestedValue(
      "modal.variant.interpretation.somatic.clinicalUtility-options.category_iid"
    ),
    value: "category_iid",
    title: "",
  },
  {
    label: getNestedValue(
      "modal.variant.interpretation.somatic.clinicalUtility-options.category_iii"
    ),
    value: "category_iii",
    title: "",
  },
